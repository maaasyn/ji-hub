...
var Seed = function () { return __awaiter(void 0, void 0, void 0, function () {
    var connection, currentDb;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, typeorm_1.createConnection()];
            case 1:
                connection = _a.sent();
                return [4 /*yield*/, typeorm_1.getRepository(Event_1.Event).find()];
            case 2:
                currentDb = _a.sent();
                if (!(currentDb.length < 1)) return [3 /*break*/, 4];
                return [4 /*yield*/, connection.manager.save(connection.manager.create(Event_1.Event, {
